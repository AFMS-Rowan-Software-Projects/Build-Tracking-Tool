...
public class CSVCreator {
	...
	public void createCSV(String name) {
		...
		//The path will need to be changed for different CPUs using this file
		//but leave ' + name + ".csv"' at the end, as this creates the name of the file. 
		info = new FileWriter("/Users//Rober//Documents//School//Rowan University//Fall 2019//Software Engineering//CSV Depository//" + name + ".csv",false);
